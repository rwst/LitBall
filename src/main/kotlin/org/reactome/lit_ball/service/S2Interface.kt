...
object S2Interface {
    ...
    data class PaperDetails(
        ...
        var authors: List<Map<String, String?>>? = emptyList(), // list of names
        val title: String? = "",
        val venue: String? = "",
        var journal: Map<String, String?>? = emptyMap(), // map keys: "name", "issn", "volume", "pageFirst", "pageLast"
        val abstract: String? = "",
